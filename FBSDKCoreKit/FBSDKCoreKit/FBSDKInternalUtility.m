...
- (BOOL)_canOpenURLScheme:(NSString *)scheme NS_EXTENSION_UNAVAILABLE("Not supported by app extensions")
{
...
- (UIWindow *)findWindow NS_EXTENSION_UNAVAILABLE("Not supported by app extensions")
{
